...
// Default fallback for service card hover overlay text when the markdown
// frontmatter `hover_text` field is empty. Edit individual values directly
// from the Sveltia CMS admin panel (Services collection → Hover Text).
